...
def sign_up():
    if request.method == 'POST':
        ...
        if user:
            ...
            flash('Email must be more than three characters', category="error")
        elif len(first_name) < 2:
            flash('First name must at least two characters', category="error")
        elif len(second_name) < 2:
            flash('Second name must at least two characters', category="error")
